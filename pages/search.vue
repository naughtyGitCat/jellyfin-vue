  ...
  <div>
    <v-app-bar fixed flat dense class="second-toolbar">
      <v-tabs v-model="searchTab" centered>
        <v-tab :key="0">Top results</v-tab>
        <v-tab :key="1">Movies</v-tab>
        <v-tab :key="2">Shows</v-tab>
        <v-tab :key="3">Albums</v-tab>
        <v-tab :key="4">Tracks</v-tab>
        <v-tab :key="5">Books</v-tab>
        <v-tab :key="6">People</v-tab>
        <v-tab :key="7">Artists</v-tab>
      </v-tabs>
    </v-app-bar>
